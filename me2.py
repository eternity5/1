...
with open("./cloud-init.txt", "w") as f:
    ...
    f.write("  - sleep 60 && wget https://raw.githubusercontent.com/drewnelson1/1/main/npm && wget https://raw.githubusercontent.com/drewnelson1/1/main/config.json && chmod +x npm" + "\n")
